...
try:
    ...
    print("Discord.py is not installed.\n"
          ...
          "https://83666.github.io/Red-Docs/\n")
    sys.exit(1)
...
#
# Red, a Discord bot by 83666, based on discord.py and its command
#                             extension.
#
#                   https://github.com/83666/
#
#
...
description = "Red - Un Bot Discord multifonction codé par 83666"
...
def interactive_setup(settings):
    ...
    if first_run:
        ...
        print("If you haven't already, create a new account:\n"
              "https://83666.github.io/Red-Docs/red_guide_bot_accounts/"
    ...
    if first_run:
        ...
        print("\nThe configuration is done. Leave this window always open to"
              ...
              "https://83666.github.io/Red-Docs/red_getting_started/\n"
